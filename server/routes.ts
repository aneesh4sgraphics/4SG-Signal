    ...
    try {
      ...
      res.json({
        card: {
          ...
          emailHygieneContact: card.emailHygieneContact,
          customer: {
            id: card.customer.id,
            ...
            address1: card.customer.address1,
            city: card.customer.city,
            state: card.customer.state,
            zip: card.customer.zip,
            shopifyCustomerId: card.customer.shopifyCustomerId,
            odooPartnerId: card.customer.odooPartnerId,
          },
        },
        completed: session.totalCompleted || 0,
        dailyTarget: DAILY_TARGET,
    ...
    try {
      ...
      res.json({
        ...
        nextCard: nextCard ? {
          ...
          emailHygieneContact: nextCard.emailHygieneContact,
          customer: {
            ...
            address1: nextCard.customer.address1,
            city: nextCard.customer.city,
            state: nextCard.customer.state,
            zip: nextCard.customer.zip,
            shopifyCustomerId: nextCard.customer.shopifyCustomerId,
            odooPartnerId: nextCard.customer.odooPartnerId,
          },
        } : null,
        completed: session.totalCompleted || 0,
        dailyTarget: DAILY_TARGET,
